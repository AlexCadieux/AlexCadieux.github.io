$(function(){});
  ...
  $(window).scroll(function(){
      ...
      if($(document).scrollTop() > $(".portfolio").offset().top - 81 && $(document).scrollTop() < $(".tools").offset().top - 80)
      {
      ...
      if($(document).scrollTop() > $(".tools").offset().top - 81 && $(document).scrollTop() < $(".main-footer").offset().top - 80)
      {
